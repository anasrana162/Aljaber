...
const Options = ({ option_package_size, option_power, selectedItemLeftPower,selectedItemLeftPackage, selectedItemRightPower,selectedItemRightPackage, dropdown, openDropDown }) => {
