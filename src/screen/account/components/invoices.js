...
const Invoices = ({ order_detail_items, showMore, product_options, subtotal, shipping_handling, total, navProps }) => {
  return (
    <>
                    ...
                    <>
                        {item?.price != 0 &&
                            <>
                                ...
                                {/* QTY */}
                                <View style={[styles.small_container, { width: "17.5%" }]}>
                                    <Text style={styles.small_container_text}>{item.qty_invoiced}</Text>
                                </View>
                                {/* Subtotal */}
                                <View style={[styles.small_container, { width: "17.5%" }]}>
